...
public class GoogleMapRequest implements MapRequest {
	...
	public GoogleMapRequest(int mapNumber, double latitude, double longitude, int zoom, int xDimension, int yDimension, Region region, Language language) {
	...
	public static class MapRequestBuilder {
		...
		public GoogleMapRequest build() {
			return new GoogleMapRequest(this);
		}
	}
}
