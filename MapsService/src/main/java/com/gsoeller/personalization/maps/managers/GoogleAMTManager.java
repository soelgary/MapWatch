...
public class GoogleAMTManager {
	...
	public Optional<GoogleHITUpdate> updateGoogleHITUpdateControl(int updateId, GoogleHITUpdate update) {
		return updateDao.updateControlResponse(updateId, update.isControlResponse());
	}
