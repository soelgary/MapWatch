...
public class GoogleMapRequestDao implements MapRequestDao {
	...
	public void addMapRequest(int mapNumber, double lat, double lon, int zoom,
			int xDimension, int yDimension, String countryCode, String language) {
		dao.addMapRequest(mapNumber, lat, lon, zoom, xDimension, yDimension, countryCode, language);
	}
