...
url = 'http://ak.dynamic.t1.tiles.virtualearth.net/comp/ch/'
query = '?mkt=en-in&it=G,VE,BX,L,LA&shading=hill&og=66&n=z&ur=US'

good = []

for tile in ["%04d" % x for x in range(10000)]:
  r = requests.get(url + tile + query)
  print r.status_code, tile
